...
public class Configuration {
    ...
    public static final String FILE_NAME = "lena.jpg";
    public static final Integer NEURONS_NUMBER = 1;
    public static final Integer PATTERNS_COUNT = 5;
    public static final Integer AGES_COUNT = 3;
